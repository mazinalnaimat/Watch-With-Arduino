...
long long PeriodChangeValue_IncreaseButton2_SetDateTime = 0;  //
long long EnterTime_IncreaseButton2_SetDateTime = 0;          //

long long PeriodChangeValue_DecreaseButton5_SetDateTime = 0;  //
long long EnterTime_DecreaseButton5_SetDateTime = 0;          //

long long PeriodChangeValue_IncreaseButton2_SetAlarm = 0;  //
long long EnterTime_IncreaseButton2_SetAlarm = 0;          //
...
bool In_IncreaseButton2_SetDateTime = 0;
bool In_DecreaseButton5_SetDateTime = 0;

bool In_IncreaseButton2_SetAlarm = 0;
...
bool MoveScreen()
{
  ...
  CurrentScreen = EventAfterPressingPushButton(PushButton3, PushButton3_Value, Previous_PushButton3_Value, CountPushButton3ForChangeScreen, 4);
...
void UpdateTheTimeAndDate(byte &_Hours, byte &_Minutes, byte &_Seconds, byte &_Hours_StopWatch, byte &_Minutes_StopWatch, byte &_Seconds_StopWatch, byte &_GregorianDay, byte &_HijriDay, byte &_DayInSet)  //OUT
{

  if (_Seconds != 59) {
    if (CountPushButton2ForStopWatch == 1) {
      _Seconds_StopWatch++;
    }
...
void ShowTimeAndDateScreen() {
  ...
  for (int i = 0; i < 20; i++) {
    ...
    if (CheckAlarmTime()) {
      ...
      if (EventAfterPressingPushButtonAndResetValue(PushButton2, PushButton2_Value, Previous_PushButton2_Value, CountPushButton2ForTuenOffAlarm)) {
        _AllowAlarm = false;
        _AllowAlarmNap = false;
        CountForNapTimes = 0;
        // CountPushButton2ForTuenOffAlarm =0;    //must write with (EventAfterPressingPushButtonAndResetValue)
      } else if (EventAfterPressingPushButtonAndResetValue(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForTuenOffAlarm)) {
    ...
    if (EventAfterPressingPushButtonAndResetValue(PushButton2, PushButton2_Value, Previous_PushButton2_Value, CountPushButton2ForDate)) {
...
void ShowStopWatchScreen() {
  ...
  for (int i = 0; i < 20; i++) {
    ...
    if (EventAfterPressingPushButtonAndResetValue(PushButton2, PushButton2_Value, Previous_PushButton2_Value, CountPushButton2ForStopWatch_Peeb)) {
      TurnOnBuzzer(Buzzer, 3000);
      delay(5);
      TurnOffBuzzer(Buzzer);
      //  CountPushButton2ForStopWatch_Peeb =0;
      CountPushButton2ForStopWatch ^= 1;
    }




    if (EventAfterPressingPushButtonAndResetValue(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForStopWatch)) {
      TurnOnBuzzer(Buzzer, 3000);
      delay(5);
      TurnOffBuzzer(Buzzer);
...
void ShowSetAlarmScreen() {
  for (int i = 0; i < 20; i++) {
    ...
    if (digitalRead(PushButton2) == 1 && !In_IncreaseButton2_SetAlarm) {
      PeriodChangeValue_IncreaseButton2_SetAlarm = millis();
      In_IncreaseButton2_SetAlarm = 1;
    }


    if (digitalRead(PushButton2) == 0) {
      PeriodChangeValue_IncreaseButton2_SetAlarm = millis();
      In_IncreaseButton2_SetAlarm = 0;
    }



    if ((EventAfterPressingPushButtonAndResetValue(PushButton2, PushButton2_Value, Previous_PushButton2_Value, CountPushButton2ForSetAlarm)) || (((1000 < millis() - PeriodChangeValue_IncreaseButton2_SetAlarm) && PeriodChangeValue_IncreaseButton2_SetAlarm != millis()) && (millis() - EnterTime_IncreaseButton2_SetAlarm > 100))) {
      EnterTime_IncreaseButton2_SetAlarm = millis();
      if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetAlarm, 2) == 0) {
        if (Minutes_Alarm < 59) {
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetAlarm, 2) == 1) {
    ...
    if (digitalRead(PushButton5) == 1 && !In_DecreaseButton5_SetAlarm) {
      PeriodChangeValue_DecreaseButton5_SetAlarm = millis();
      In_DecreaseButton5_SetAlarm = 1;
    }


    if (digitalRead(PushButton5) == 0) {
      PeriodChangeValue_DecreaseButton5_SetAlarm = millis();
...
void ShowSetDateAndTimeScreen() {
  ...
  for (int i = 0; i < 20; i++) {
    ...
    if (digitalRead(PushButton2) == 1 && !In_IncreaseButton2_SetDateTime) {
      PeriodChangeValue_IncreaseButton2_SetDateTime = millis();
      In_IncreaseButton2_SetDateTime = 1;
    }


    if (digitalRead(PushButton2) == 0) {
      PeriodChangeValue_IncreaseButton2_SetDateTime = millis();
      In_IncreaseButton2_SetDateTime = 0;
    }



    if ((EventAfterPressingPushButtonAndResetValue(PushButton2, PushButton2_Value, Previous_PushButton2_Value, CountPushButton2ForSetTimeAndDate)) || (((1000 < millis() - PeriodChangeValue_IncreaseButton2_SetDateTime) && PeriodChangeValue_IncreaseButton2_SetDateTime != millis()) && (millis() - EnterTime_IncreaseButton2_SetDateTime > 100))) {
      EnterTime_IncreaseButton2_SetDateTime = millis();
      if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 0) {
        Seconds = 0;

        //CountPushButton2ForSetTimeAndDate = 0;
        ShowTimeOnLcd(4, 0, GetTime(Hours, Minutes, Seconds));

      } else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 1) {
        if (Minutes < 59) {
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 2) {
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 3) {
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 4) {

        if (GregorianMonthInSet < 11) {
          GregorianMonthInSet++;
        } else {
          GregorianMonthInSet = millis() + 5000;
        }
        //CountPushButton2ForSetTimeAndDate = 0;
      ...
      } else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 5) {
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 6) {
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 7) {
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 8) {
        HijriYear++;
        //CountPushButton2ForSetTimeAndDate = 0;
      ...
      else if (EventAfterPressingPushButton(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetTimeAndDate, 10) == 9) {
    ...
    if (digitalRead(PushButton5) == 1 && !In_DecreaseButton5_SetDateTime) {
