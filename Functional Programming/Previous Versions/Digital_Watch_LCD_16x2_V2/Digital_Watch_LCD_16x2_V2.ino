       ...
       else
       {
         ...
         AllowAlarm();
           ...
           if( EventAfterPressingPushButtonAndResetValue(PushButton2,PushButton2_Value,Previous_PushButton2_Value,CountPushButton2ForStopWatch_Peeb))
            ...
            // EventAfterPressingPushButton(PushButton2,PushButton2_Value,Previous_PushButton2_Value,CountPushButton2ForStopWatch,2);
      ...
      if(MoveScreen())
       {
        ...
        if(EventAfterPressingPushButtonAndResetValue(PushButton2, PushButton2_Value,Previous_PushButton2_Value, CountPushButton2ForSetAlarm))
        {
        ...
        if(EventAfterPressingPushButtonAndResetValue(PushButton5, PushButton5_Value,Previous_PushButton5_Value, CountPushButton5ForSetAlarm))
        {
          if(EventAfterPressingPushButton(PushButton4,PushButton4_Value,Previous_PushButton4_Value,CountPushButton4ForSetAlarm,2)==0)
            {if(Minutes_Alarm >0)
            {
       ...
       else
       {
                     ...
                     if(MoveScreen())
            {
              break;
                 ...
                 if(EventAfterPressingPushButtonAndResetValue(PushButton2,PushButton2_Value,Previous_PushButton2_Value,CountPushButton2ForSetTimeAndDate))
                {
               ...
               if(EventAfterPressingPushButtonAndResetValue(PushButton5,PushButton5_Value,Previous_PushButton5_Value,CountPushButton5ForSetTimeAndDate))
                {
                   if(EventAfterPressingPushButton(PushButton4,PushButton4_Value,Previous_PushButton4_Value,CountPushButton4ForSetTimeAndDate,10)==0)
                   {
                      Seconds = 0;
