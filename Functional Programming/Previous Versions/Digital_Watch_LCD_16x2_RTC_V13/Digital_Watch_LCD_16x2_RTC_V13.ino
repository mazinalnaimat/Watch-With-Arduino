...
{
  if ((EventAfterPressingPushButtonAndResetValue(PushButton4, PushButton4_Value, Previous_PushButton4_Value, CountPushButton4ForSetAlarm)) || (((refPeriodChangeValue_IncreaseButton4_SetAlarm < millis() - PeriodChangeValue_IncreaseButton4_SetAlarm) && PeriodChangeValue_IncreaseButton4_SetAlarm != millis()) && (millis() - EnterTime_IncreaseButton4_SetAlarm > _refPeriod_EnterTime_IncreaseButton4_SetAlarm))) {
    if (IsAllowAlarm) {
    UpdateAlarmOperationbtn4(TurnOffAlarm, IsAllowAlarm, IsAllowAlarmNap,CountForNapTimes);
    }
...
//////////////////////////////////////////////////////////////////////-----------------------------------------------------//////////////////////////////////////////////////////
void OperationsOfExecuteProcessRepeatlyWhilePressingbtn(int PushButton, bool & PushButton_Value,long long & Period, bool & In  , bool InputPull_Type = Input_PullUp)
{
...
void ShowSetAlarmScreen() {
   ...
   OperationsOfExecuteProcessRepeatlyWhilePressingbtn( PushButton4, PushButton4_Value, PeriodChangeValue_IncreaseButton4_SetAlarm, In_IncreaseButton4_SetAlarm);  
   CheckAndExecuteIncreaseDigit(refPeriod_EnterTime_IncreaseButton4_SetAlarm);
   OperationsOfExecuteProcessRepeatlyWhilePressingbtn( PushButton5, PushButton5_Value, PeriodChangeValue_DecreaseButton5_SetAlarm, In_DecreaseButton5_SetAlarm);    
...
void ShowSetDateAndTimeScreen() {
  ...
  OperationsOfExecuteProcessRepeatlyWhilePressingbtn(PushButton4, PushButton4_Value, PeriodChangeValue_IncreaseButton4_SetDateTime, In_IncreaseButton4_SetDateTime);
  CheckAndExecuteIncreaseDigitInSetTimeAndDateScreen(CurrentSetDigit);
  OperationsOfExecuteProcessRepeatlyWhilePressingbtn(PushButton5, PushButton5_Value, PeriodChangeValue_DecreaseButton5_SetDateTime, In_DecreaseButton5_SetDateTime);   
