...
void ShowTimeAndDateScreen() {
  ...
  if (!(digitalRead(PushButton4) == LOW && digitalRead(PushButton5) == LOW) && IsReadStartPeriodForChangeHoursType) {
    IsChangedHoursType = 0;
    IsReadStartPeriodForChangeHoursType = 0;
  }
  if (digitalRead(PushButton4) == LOW && digitalRead(PushButton5) == LOW && IsChangedHoursType == 0) {
    if (IsReadStartPeriodForChangeHoursType == 0) {
      StartPeriodForChangeHoursType = millis();
      IsReadStartPeriodForChangeHoursType = 1;
    }
  ...
  CountPushButton3ForSetAlarm = 0;         //to reback the pointer 
  CountPushButton3ForSetTimeAndDate = 0;   //to reback the pointer 
