...
#define PushButton1 A0   //the left up PushButton 
#define PushButton2 A1   //the left down PushButton 
#define PushButton3 A2   //the right down PushButton 
#define PushButton4 A3   //the right Up PushButton 
#define PushButton5 A4   //the middle PushButton 
#define Buzzer 11
...
void CheckLight()
{
  ...
  if(PushButton1_Value == 0 /*&& ReadPushButton1AsHigh == 1*/)
  {
